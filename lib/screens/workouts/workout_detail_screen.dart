...
import 'package:cashfit/replace_context_provider.dart';
...
class WorkoutDetailScreen extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> _fetchAllData(
    ...
    final results = await Future.wait([stepGoalFuture, ...exerciseFutures]);
    ...
    return {'stepGoal': stepGoal, 'exercisesByDay': exercisesByDay};
  }
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildStepGoalCard(theme, colorScheme, dayNumber, stepGoal),
            ],
          ),
        ),
        const SizedBox(height: 12),
